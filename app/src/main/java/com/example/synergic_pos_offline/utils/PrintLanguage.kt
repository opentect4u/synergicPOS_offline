...
object PrintLanguage {
    ...
    private val WORDS: Map<String, Array<String>> = buildMap {
        ...
        // कैशियर, and खजांची reads like something out of a ledger from 1950. The same
        // choice REPORT makes just below, for the same reason. Tamil is the exception -
        // காசாளர் is the ordinary word there and is what a Tamil bill would say.
        w("CASHIER", "कैशियर", "कॅशिअर", "காசாளர்", "ক্যাশিয়ার", "క్యాషియర్", "ಕ್ಯಾಷಿಯರ್", "કેશિયર", "କ୍ୟାଶିଅର", "ਕੈਸ਼ੀਅਰ", "কেশিয়াৰ")
