...
import com.example.synergic_pos_offline.utils.CreditCustomerDialog
    ...
    private fun showCreditCustomerDialog() {
        ...
        CreditCustomerDialog.show(
            ...
            prefill = CreditCustomerDialog.Prefill(
                phone = creditCustomerPhone, name = creditCustomerName,
                address = creditCustomerAddress, gstin = creditCustomerGstin
            ),
            onFile = currentCustomer(),
            money = ::money
        ) { saved ->
            creditCustomerPhone = saved.phone
            creditCustomerName = saved.name
            creditCustomerAddress = saved.address
            creditCustomerGstin = saved.gstin
            updateHeaderWithCustomer()
